...
// Upstream may return 403 content-policy errors while a configured temporary
// rule matches the same status and keywords. These request-policy errors must
// not mutate account state or trigger failover.
