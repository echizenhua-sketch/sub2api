export default {
  ...
  admin: {
    ...
    accounts: {
      kiro: {
        accessToken: '访问令牌',
        accessTokenPlaceholder: '粘贴 access_token（约 200-300 字符）',
        accessTokenHint: '从 Kiro OAuth 授权流程获取的访问令牌',
        accessTokenRequired: '请输入访问令牌',
        refreshToken: '刷新令牌',
        refreshTokenPlaceholder: '粘贴 refresh_token（约 200-300 字符）',
        refreshTokenHint: '用于自动续期访问令牌',
        refreshTokenRequired: '请输入刷新令牌',
        clientId: '客户端 ID',
        clientIdPlaceholder: '输入 client_id',
        clientIdRequired: '请输入客户端 ID',
        clientSecret: '客户端密钥',
        clientSecretPlaceholder: '粘贴 client_secret（JWT 格式，可能较长）',
        clientSecretHint: 'JWT 格式的客户端密钥',
        ...
        regionDefault: '默认',
        regionCustom: '自定义',
        regionCustomPlaceholder: '输入自定义区域，如 us-west-2',
        loginType: '登录类型',
        loginTypeDefault: '默认',
        loginTypeHint: '决定 user-agent 与 profileArn 默认值',
        profileArn: 'Profile ARN',
        profileArnCustom: '自定义 ARN',
        profileArnCustomPlaceholder: 'arn:aws:codewhisperer:...',
        machineId: '机器码（可选）',
        machineIdPlaceholder: '64 位 hex，留空则后端自动生成',
        machineIdHint: '留空时后端自动生成 sha256("kiro-device-{accountId}")',
      },
      title: '账号管理',
      ...
      tempUnschedulable: {
        ...
        keywords: '关键词（可选）',
        keywordsPlaceholder: '留空则仅按错误码匹配',
        keywordsHint: '可留空：留空时只要错误码命中即触发；填写时用逗号分隔，需命中其中之一。',
        description: '描述',
