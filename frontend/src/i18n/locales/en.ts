  ...
  admin: {
    ...
    accounts: {
      kiro: {
        ...
        accessTokenPlaceholder: 'Paste access_token (~200-300 chars)',
        accessTokenHint: 'Access token obtained from the Kiro OAuth flow',
        accessTokenRequired: 'Please enter the access token',
        refreshToken: 'Refresh Token',
        refreshTokenPlaceholder: 'Paste refresh_token (~200-300 chars)',
        refreshTokenHint: 'Used to automatically renew the access token',
        refreshTokenRequired: 'Please enter the refresh token',
        clientId: 'Client ID',
        clientIdPlaceholder: 'Enter client_id',
        clientIdRequired: 'Please enter the client ID',
        clientSecret: 'Client Secret',
        clientSecretPlaceholder: 'Paste client_secret (JWT, may be long)',
        clientSecretHint: 'Client secret in JWT format',
        clientSecretRequired: 'Please enter the client secret',
        showAdvanced: 'Show advanced options',
        hideAdvanced: 'Hide advanced options',
        region: 'Region',
        regionDefault: 'default',
        regionCustom: 'Custom',
        regionCustomPlaceholder: 'e.g. us-west-2',
        loginType: 'Login Type',
        loginTypeDefault: 'default',
        loginTypeHint: 'Determines user-agent and default profileArn',
        profileArn: 'Profile ARN',
        profileArnCustom: 'Custom ARN',
        profileArnCustomPlaceholder: 'arn:aws:codewhisperer:...',
        machineId: 'Machine ID (optional)',
        machineIdPlaceholder: '64-char hex, leave blank for auto-generation',
        machineIdHint: 'Auto-generated as sha256("kiro-device-{accountId}") when blank',
      },
      ...
      tempUnschedulable: {
        ...
        keywordsPlaceholder: 'Leave empty to match by error code only',
        keywordsHint: 'Optional: if empty, the rule triggers on error-code match alone; if set, separate with commas and any match triggers.',
        description: 'Description',
